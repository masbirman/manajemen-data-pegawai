...
function AppContent() {
  ...
  // Handle /admin route - always allow access for superadmin login
  if (isAdminRoute && !isAuthenticated) {
    return (
      <AdminLogin
        onLoginSuccess={(user, permissions) => {
          handleLoginSuccess(user, permissions);
